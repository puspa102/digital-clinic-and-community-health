...
const QuickActions = ({ actions }) => {
  return (
    <div>
      <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4 tracking-tight">Quick Actions</h2>
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center p-5 rounded-2xl border transition-all duration-300 group ${
                action.accent
                  ? "bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/10 dark:to-orange-900/10 border-red-100 dark:border-red-900/30 hover:shadow-lg hover:shadow-red-500/10 hover:-translate-y-1"
            ...
            >
              ...
              <span className={`text-sm font-semibold ${action.accent ? "text-red-700 dark:text-red-400" : "text-gray-700 dark:text-gray-300"}`}>
                {action.label}
              </span>
            </Link>
          );
