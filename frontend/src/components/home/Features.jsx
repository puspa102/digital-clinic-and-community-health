  ...
  const featureGroups = [
    {
      ...
      features: [
        ...
        },
        {
          ...
          gradient:
            "from-sky-100 to-indigo-100 dark:from-sky-900/30 dark:to-indigo-900/30",
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          gradient:
            "from-green-100 to-lime-100 dark:from-green-900/30 dark:to-lime-900/30",
        ...
        },
        {
          ...
          gradient:
            "from-lime-100 to-yellow-100 dark:from-lime-900/30 dark:to-yellow-900/30",
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          gradient:
            "from-purple-100 to-fuchsia-100 dark:from-purple-900/30 dark:to-fuchsia-900/30",
  ...
  return (
    ...
    >
          ...
          <div key={groupIndex} className="group">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3
                  className={`text-3xl font-bold bg-gradient-to-r ${group.color} bg-clip-text text-transparent`}
                >
                  {group.category}
                </h3>
              </div>
              <div
                className={`h-1 w-20 bg-gradient-to-r ${group.color} rounded-full`}
              />
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
              {group.features.map((feature, featureIndex) => {
                ...
                return (
                  <div
                    key={featureIndex}
                    className={`group/card card bg-gradient-to-br ${feature.gradient} border border-white/50 dark:border-white/10 hover:border-white/80 dark:hover:border-white/20 p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden relative`}
                  >
                    {/* Animated Background Shine */}
                    <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-white/0 to-white/5 dark:to-white/0 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500" />

                    {/* Icon Container */}
                    <div
                      className={`relative z-10 inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.gradient} border border-white/30 shadow-lg shadow-${feature.accent.split("-")[1]}-500/20 mb-6 group-hover/card:scale-110 transition-transform duration-300`}
                    >
                      <div
                        className={`absolute inset-0 rounded-2xl ${feature.accent}/20 blur-lg opacity-0 group-hover/card:opacity-100 transition-opacity`}
                      />
                      <Icon
                    ...
                    {/* Content */}
                    <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-3 relative z-10 group-hover/card:text-transparent group-hover/card:bg-clip-text group-hover/card:bg-gradient-to-r group-hover/card:from-teal-600 group-hover/card:to-indigo-600 transition-all">
                      {feature.title}
                    </h4>
                    <p className="text-gray-700 dark:text-gray-400 leading-relaxed relative z-10">
                      {feature.description}
                    </p>
      ...
      <div className="relative z-10 mt-24">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-teal-600/10 to-indigo-600/10 dark:from-teal-600/5 dark:to-indigo-600/5 border border-teal-200 dark:border-teal-700/30 rounded-3xl p-12 lg:p-16 text-center backdrop-blur-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/register"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 text-white font-bold rounded-xl shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 transition-all duration-300 hover:-translate-y-1"
            >
              Get Started Today
              <svg
                className="w-5 h-5"
