...
import { Sun, Moon, Bell, Shield, User, Mail, Lock, Stethoscope } from "lucide-react";
...
const Settings = () => {
  ...
  const [notifications, setNotifications] = useState(() => {
    const saved = localStorage.getItem("doctorNotificationSettings");
    return saved
      ? JSON.parse(saved)
      : {
  ...
  const [preferences, setPreferences] = useState(() => {
    const saved = localStorage.getItem("doctorPreferences");
    return saved
      ? JSON.parse(saved)
      : {
          language: "en",
  ...
  const handleSaveNotifications = () => {
    localStorage.setItem("doctorNotificationSettings", JSON.stringify(notifications));
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      ...
                      <div>
                        ...
                        <span className="inline-block px-2 py-0.5 text-xs font-medium bg-green-100 text-green-700 dark:bg-green-800 dark:text-green-200 rounded-full mt-1">
                          Doctor
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => handlePreferenceChange("consultationDuration", e.target.value)}
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        >
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Notifications when prescriptions are filled or updated",
                      },
                      {
                        key: "weeklyReports",
                        label: "Weekly Reports",
                        desc: "Get weekly summary reports of your practice via email",
                      },
                    ].map(({ key, label, desc }) => (
                      <div
                        key={key}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
