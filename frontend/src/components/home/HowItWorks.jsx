    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
          {/* Connector Line (Desktop) with solid color */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-1 bg-teal-400 -z-10 rounded-full shadow-lg shadow-teal-400/30"></div>
          ...
          {steps.map((item, i) => (
            ...
            >
              {/* Main Card Container */}
              <div className="w-28 h-28 rounded-3xl bg-white dark:bg-gray-800 border-3 border-gray-100 dark:border-gray-700 shadow-xl hover:shadow-2xl flex items-center justify-center mb-8 relative z-10 transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-2 group-hover:border-teal-400 dark:group-hover:border-teal-600">
                {/* Step Number Badge */}
                <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-teal-500 text-white flex items-center justify-center font-bold text-sm shadow-lg shadow-teal-500/40 group-hover:shadow-teal-500/60 transition-all group-hover:scale-110">
                  {item.step}
                </div>
              ...
              {/* Description */}
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-xs mx-auto text-sm sm:text-base font-semibold">
                {item.description}
              </p>
            </div>
          ))}
        ...
        >
          ...
          <a
            href="/register"
            className="inline-flex items-center gap-2 px-8 py-4 bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-xl shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 transition-all duration-300 hover:-translate-y-1"
          >
            Create Your Account
